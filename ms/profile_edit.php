                      ...
                      <div class="">
                       ...
                       <input type="hidden" name="idstaff" id="idstaff" value="<?php echo $row['staff_ID']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="no" name="no" value="<?php echo $row['staff_no']; ?>">
                          </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ชื่อ-นามสกุล</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="name_staff" name="name_staff" value="<?php echo $row['staff_name']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="birth" name="birth" value="<?php echo $row['staff_birth']; ?>">
                            </div>
                            <label class="col-lg-1 control-label">เพศ</label>
                            <div class="col-lg-2">
                            <select class="form-control m-bot15" id="sex" name="sex" value="<?php echo $row['staff_sex']; ?>">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3">
                              <input type="text" class="form-control" id="nationality" name="nationality" value="<?php echo $row['staff_nationality']; ?>">
                            </div>
                            <label class="col-lg-1 control-label">เชื้อชาติ</label>
                            <div class="col-lg-2">
                              <input type="text" class="form-control" id="race" name="race" value="<?php echo $row['staff_race']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ศาสนา</label>
                            <div class="col-lg-3">
                              <input type="text" class="form-control" id="religion" name="religion" value="<?php echo $row['staff_religion']; ?>">
                            </div>
                            <label class="col-lg-1 control-label">สถานะภาพสมรส</label>
                            <div class="col-lg-2">
                              <input type="text" class="form-control" id="statuslove" name="statuslove" value="<?php echo $row['staff_statuslove']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">เบอร์ติดต่อ</label>
                            <div class="col-lg-3">
                              <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $row['staff_phone']; ?>">
                            </div>
                            <label class="col-lg-1 control-label">Email</label>
                            <div class="col-lg-2">
                              <input type="text" class="form-control" id="email" name="email" value="<?php echo $row['staff_email']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <div class="col-lg-8">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="position_staff" name="position_staff" value="<?php echo $row['staff_position']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ตำแหน่งรักษาการ</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="actfor" name="actfor" value="<?php echo $row['staff_actfor']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ตำแหน่งช่วยรักษาการ</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="help" name="help" value="<?php echo $row['staff_help']; ?>">
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">ส่วน/ฝ่าย</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="group" name="group" value="<?php echo $row['staff_group']; ?>" >
                            </div>
                          </div>
                          <div class="form-group">
                            <label class="col-lg-2 control-label">หน่วยงานและองค์กร</label>
                            <div class="col-lg-6">
                              <input type="text" class="form-control" id="department2" name="department2" value="<?php echo $row['staff_department']; ?>" >
                            </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-lg-3">
                              <input type="text" class="form-control" id="user" name="user" value="<?php echo $row['staff_user']; ?>" >
                            </div>
                            ...
                            <div class="col-lg-2">
                              <input type="password" class="form-control" id="pass" name="pass" value="<?php echo $row['staff_pass']; ?>" >
                                ...
                                <div class="col-lg-2">
                                    <input type="number" class="form-control" id="USERID" name="USERID" value="<?php echo $row['USERID']; ?>" >
                                </div>
                          </div>
                          <?php }} ?>
                          <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                            <input type="hidden" name="staffMethod_edit" id="staffMethod_edit" value="2">
