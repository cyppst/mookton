                                ...
                                <div class="panel-body">
                                    <div id="leave" class="tab-pane ">
                                        ...
                                        <div class="row">
                                            ...
                                            <br><br><br>
                                            <div class="col-lg-offset-2 col-lg-3 pull-right">
                                                <a href="#addleave1" data-toggle="modal" class="btn btn-primary icon_plus_alt2">
                                                    เพิ่มผู้อนุมัติ
                                                </a>
                                        ...
                                        <table class="table table-bordered" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn" onclick="window.location.href='/ms/uploads/<?php echo $row["leave_doc"];?>'"><i class="icon_documents_alt"></i></button></button></td>
                                                <?php if(isset($_SESSION['staff_user'])&&($_SESSION['staff_lv'])>=2){
                                                    ...
                                                    <th>
                                                        <div class="btn-group">
                                                            ...
                                                            <!--end btn edit-->
                                                            <!--ปุ่มลบ-->
                                                            <a class="btn btn-danger" href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='action.php?Delleave=<?php echo $row["leave_ID"]; ?>';}"><i class="icon_close_alt2"></i></a>
                                                        </div>
                                                    </th>
                                                <?php } ?>
                                    ...
                                    <!--โมเดลเพิ่มผู้อนุมัติ-->
                                    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="addleave1" class="modal fade">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button aria-hidden="true" data-dismiss="modal" class="close" type="button">×</button>
                                                    <h4 class="modal-title">เพิ่มข้อมูลผู้อนุมัติ</h4>
                                                </div>
                                                <div class="modal-body">
                                                    ...
                                                    <form role="form" method="post" action="action.php" enctype="multipart/form-data">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="leaveok">ชื่อผู้อนุมัติ</label>
                                                            <input type="text" class="form-control" id="addleavesub" name="addleavesub" >
                                                        </div>
                                                        ...
                                                        <input type="hidden" name="leaveMethod14" id="leaveMethod14" value="1">
                                                        <button type="submit" class="btn btn-primary">บันทึก</button>
                                                    </form>
                                                </div>
                                            </div>
