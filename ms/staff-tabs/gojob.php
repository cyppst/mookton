                                    ...
                                    <div id="gojob" class="tab-pane ">
                                        ...
                                        <table class="table table-bordered" id="example1">
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn" onclick="window.location.href='/ms/uploads/<?php echo $row["gojob_doc"];?>'"><i class="icon_documents_alt"></i></button></button></td>
                                                <?php if(isset($_SESSION['staff_user'])&&($_SESSION['staff_lv'])>=2){
                                                    ...
                                                    <th>
                                                        <div class="btn-group">
                                                            ...
                                                            <!--end btn edit-->
                                                            <!--ปุ่มลบ-->
                                                            <a class="btn btn-danger" href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='action.php?Delgojob=<?php echo $row["gojob_ID"]; ?>';}"><i class="icon_close_alt2"></i></a>
                                                        </div>
                                                    </th>
                                                <?php } ?>
