...
if(isset($_POST['staffMethod'])){
    if($_POST['no']=="" or $_POST['name_staff']=="" or $_POST['user']=="" or $_POST['pass']=="" or $_FILES["fileToUploadimg"]["name"]==""){
        ...
        header('Location: add_staff2.php');   
     }else{
        ...
        ('".$_POST['no']."','".$_POST['name_staff']."','".$_POST['birth']."','".$_POST['nationality']."','".$_POST['race']."','".$_POST['sex']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['religion']."','".$_POST['statuslove']."','".$_POST['user']."','".$_POST['pass']."','".$_POST['actfor']."','".$_POST['help']."','".$_POST['position_staff']."','".$_POST['emtype']."','".$_POST['department2']."','".$_POST['group']."','".$_POST['lv']."','".$namefile."')";
