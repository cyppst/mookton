           <div id="rank" class="tab-pane  ">
                  ...
                  <table class="table table-bordered" id="example38">
                  <thead>
                    <tr>
                      <th>ลำดับ</th>
                  ...
                  if(isset($_POST['start7'])){
                    ...
                    <!--ปุ่มแก้ไข-->
                     ...
                     <!--end btn edit-->
                     <!--ปุ่มลบ-->
                     <a class="btn btn-danger" href="JavaScript:if(confirm('ยืนยันการลบ')==true){window.location='app2.php?Delrank=<?php echo $row["rank_ID"]; ?>';}"><i class="icon_close_alt2"></i></a>
                      </div>
                     </th>
                     <?php } ?>
...
<script>
        $(document).ready(function () {
            $('#example38').DataTable({
				...
				window.location = 'mpdf/rank_pdf.php?IDedit=<?php echo $_SESSION['staff_ID'] ?>';
				}
					},
