              ...
              <table class="table table-bordered" id="example">
                  ...
                  $sql = "SELECT * FROM staff";
                    ...
                    ?>
                     ...
                     <div class="btn-group">
                    <!--ปุ่มแก้ไข-->
                     <a  class="btn btn-success" href="JavaScript:if(confirm('ยืนยันการเลือก')==true){window.location='/ms/staff-tabs/profile.php?IDedit=<?php echo $row["staff_ID"]; ?>';}"data-toggle="modal"><i class="icon_pencil-edit_alt"></i></a>
                     <!--end btn edit-->
                     <!--ปุ่มลบ-->
                ...
                buttons: [
                    ...
                    { extend: 'excel', text: 'Excel File' },
                    {
                        ...
                        action: function ( e, dt, button, config ) {
                            window.location = '/ms/mpdf/index2_pdf.php';
                        }
                    },
