                      ...
                      <div class="modal-body">
                        ...
                        <form role="form" method="post" action="app2.php" enctype="multipart/form-data">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" id="addyear"  class="form-control" name="addyear" placeholder="ระยะเวลา">
                          </div>
                          <div class="form-group">
                            <label for="yearend">ถึง</label>
                            <input type="date"  id="addyearend"  class="form-control" name="addyearend" placeholder="ระยะเวลา">
                          </div>
                      ...
                      <div class="modal-body">
                        ...
                        <input type="hidden" name="id" id="id" value="">
                          ...
                          <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="yearend" name="year2">
                          </div>
...
<script>
        $(document).ready(function () {
            $('#example1').DataTable({
				...
				window.location = '/mpdf/job_pdf.php?IDedit=<?php echo $_SESSION['staff_ID'] ?>';
				}
					},
